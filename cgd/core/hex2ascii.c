...
static const char *const hex2ascii_table[256] = {
    ...
    "\\xB6",  "\\xB7",  "\\xB8",  "\\xB9", "\\xBA", "\\xBB",
    "\\xBC",  "\\xBD",  "\\xBE",  "\\xBF", "\\xC0", "\\xC1",
    ...
    "\\xEC",  "\\xED",  "\\xEE",  "\\xEF", "\\xF0", "\\xF1",
    "\\xF2",  "\\xF3",  "\\xF4",  "\\xF5", "\\xF6", "\\xF7",
    "\\xF8",  "\\xF9",  "\\xFA",  "\\xFB", "\\xFC", "\\xFD",
    "\\xFE",  "\\xFF"
};

const char *u_hex2ascii(u8 hex)
{
    return hex2ascii_table[hex];
}
